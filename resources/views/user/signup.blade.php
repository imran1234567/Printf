...
@section('title')
  Sign-Up -Oxedent Technology PVT. LTD
@endsection

@section('content')
   <div class="row">

    <h2><i class="material-icons" style="color:darkcyan; font-size:40px;">input</i>   Sign-Up</h2>
    ...
    @endif
    <form class="col s12" action="{{ route('user.signup')}}" masthod="POST">
      <div class="row">
